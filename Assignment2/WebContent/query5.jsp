		...
		<div class="wrap-contact100">
			<div class="contact100-form-title" style="background-image: url(images/bg-01.jpg);">
				<span class="contact100-form-title-1">
					CS 5513 Web Application Page 5 of 10
				</span>

				<span class="contact100-form-title-2">
					Insert a Medicine Records
				</span>
				<span class="contact100-form-title-1">
			...
			<form action = "query5_action.jsp">	
				<div class="wrap-input100 validate-input"> &nbsp; Code:  &nbsp;
				...
				<div class="wrap-input100 validate-input"> &nbsp; Quantity:  &nbsp;

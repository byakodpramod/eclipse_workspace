		...
		<div class="wrap-contact100">
			<div class="contact100-form-title" style="background-image: url(images/bg-01.jpg);">
				<span class="contact100-form-title-1">
					CS 5513 Web Application Page 6 of 10
				</span>

				<span class="contact100-form-title-2">
					Retrieve Patient Info for particular month and year
				</span>
				<span class="contact100-form-title-1">
			...
			<form action = "query6_action.jsp">	
				<div class="wrap-input100 validate-input"> &nbsp; Month:  &nbsp;
					<input type="text" name="month" />
				</div>
				
				<div class="wrap-input100 validate-input"> &nbsp; Year:  &nbsp;

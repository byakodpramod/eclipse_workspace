		...
		<div class="wrap-contact100">
			<div class="contact100-form-title" style="background-image: url(images/bg-01.jpg);">
				<span class="contact100-form-title-1">
					CS 5513 Web Application Page 8 of 10
				</span>

				<span class="contact100-form-title-2">
					nurses who tend to patients that are given a certain medicine
				</span>
				<span class="contact100-form-title-1">
			...
			<form action = "query8_action.jsp">	
				<div class="wrap-input100 validate-input"> &nbsp; Medicine Code:  &nbsp;
